...
\includegraphics[scale=0.65]{obrazky-figures/class_diagram.png}
...
each part of it separately. The structure of the tests directory copies the structure of the source code.
...
This test case is meant to verify that RPQRParser can parse tokens prepared by RPQRScanner
and create an abstract syntactic tree out of them. This should be isolated from the implementation
of any plugins, and thus mock plugins were created. Mock plugins are loaded into the configuration
and provide simple commands.
